package com.docchain.flows;

import co.paralleluniverse.fibers.Suspendable;
import com.docchain.contracts.RegisterContract;
...
public class RegisterFlow extends FlowLogic<SignedTransaction> {
    ...
    public SignedTransaction call() throws FlowException {
        ...
        final Command<RegisterContract.Commands.Register> txCommand = new Command<>(
                ...
                Arrays.asList(tempState.getFromUser().getOwningKey(), tempState.getToUser().getOwningKey()));
        ...
        final SignedTransaction fullySignedTx = subFlow(
                new CollectSignaturesFlow(partSignedTx, Arrays.asList(ownerSession), CollectSignaturesFlow.Companion.tracker()));

        // Stage 5.
        progressTracker.setCurrentStep(FINALISING_TRANSACTION);
        // Notarise and record the transaction in both parties' vaults.
        return subFlow(new FinalityFlow(fullySignedTx, Arrays.asList(ownerSession)));
    }
